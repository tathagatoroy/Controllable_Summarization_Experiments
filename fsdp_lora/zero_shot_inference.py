...
def get_quantized_model(model_id):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="output", help="Directory to save the generated summaries.")
    args = parser.parse_args()

    os.makedirs(args.output_dir, exist_ok=True)

    model = get_quantized_model(args.model_id)
    ...
    result_path = os.path.join(args.output_dir , f"result_{args.attribute}.pkl")
